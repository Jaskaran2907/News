              ...
              <div className="modal-dialog">
                <div className="modal-content">
                  ...
                  <div className="modal-body" style={{background:"#E2E2E2"}}>
                    <p>
                    Currently, due to limitations of the free API plan, news searches are only supported for the United States. The language must also be set to English; otherwise, results may not appear. You may choose any category when the country is set to the US. Writing a keyword resets the filters.
                    </p>
                  </div>
